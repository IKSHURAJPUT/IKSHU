...
public class PC3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pc3);
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(PC3.this, PC3a.class);
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(PC3.this, PC3de.class);
                startActivity(intentLoadNewActivity);
            }
        });
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(PC3.this, PC.class);
                startActivity(intentLoadNewActivity);
            }
        });
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(PC3.this, Cart.class);
                startActivity(intentLoadNewActivity);
            }
        });
    }
