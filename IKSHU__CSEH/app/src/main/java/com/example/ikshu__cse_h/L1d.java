...
public class L1d extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1d.this, L1e.class);
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1d.this, L1c.class);
                startActivity(intentLoadNewActivity);
            }
        });
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1d.this, L1.class);
                startActivity(intentLoadNewActivity);
            }
        });
    }
