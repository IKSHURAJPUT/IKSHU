...
public class L1c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1c.this, L1d.class);
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1c.this, L1b.class);
                startActivity(intentLoadNewActivity);
            }
        });
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1c.this, L1.class);
                startActivity(intentLoadNewActivity);
            }
        });
    }
