...
public class L1a extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1a.this, L1b.class);
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1a.this, L1e.class);
                startActivity(intentLoadNewActivity);
            }
        });
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(L1a.this, L1.class);
                startActivity(intentLoadNewActivity);
            }
        });
    }
