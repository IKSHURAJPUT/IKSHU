...
public class M2c extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m2c);
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(M2c.this, M2d.class);
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(M2c.this, M2b.class);
                startActivity(intentLoadNewActivity);
            }
        });
        ...
        myImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intentLoadNewActivity = new Intent(M2c.this, M2.class);
                startActivity(intentLoadNewActivity);
            }
        });
    }
